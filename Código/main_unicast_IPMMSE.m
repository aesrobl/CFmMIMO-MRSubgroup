...
for n = 1:nbrOfSetups
    ...
    [SE_P_MMSE_uni(:,n)] = functionComputeSE_downlink_P_MMSE(Hhat,H,D,R,C,tau_c,tau_p,nbrOfRealizations,N,sum(K),L,p,gainOverNoisedB,rho_tot);
    ASE_P_MMSE_uni(tau_p,n) = sum(SE_P_MMSE_uni(:,n));
end
