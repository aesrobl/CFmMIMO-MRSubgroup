function [gainOverNoisedB,R,pilotIndex,D,APpositions,UEpositions,distances] = generateSetupUnicast(L,K,N,tau_p,nbrOfSetups,seed,ASD_varphi,ASD_theta)
...
%     plot(APpositionsWrapped,'xr')
    ...
    %    shadowing = zeros(1,L);   
        ...
        gainOverNoisedB(:,k,n) = constantTerm - alpha*log10(distances(:,k,n)) + abs(shadowing)' - noiseVariancedBm;                                  
